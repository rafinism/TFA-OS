      ...
      <div className="min-h-screen lg:pl-64">
        ...
        <div className="border-b border-tfa-border-subtle bg-tfa-background px-4 py-2 lg:hidden">
          <button
            ...
            className="inline-flex min-h-10 items-center gap-2 rounded-lg px-3 text-sm font-medium text-tfa-text-secondary hover:bg-tfa-surface-hover hover:text-tfa-text"
          >
            <Menu size={18} />
            Navigation
          </button>
