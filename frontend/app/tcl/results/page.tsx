    ...
    <main className="min-h-screen bg-tfa-background text-tfa-text">
      ...
      <div className="mx-auto w-full max-w-5xl px-5 py-10 lg:px-8">
        <header className="border-b border-tfa-border-subtle pb-8">
          ...
          <p className="mt-3 text-sm text-tfa-text-secondary">Verified official match results.</p>
        </header>
        <section className="mt-8 rounded-2xl border border-dashed border-tfa-border bg-tfa-surface p-12 text-center">
          ...
          <p className="mx-auto mt-2 max-w-xl text-xs leading-6 text-tfa-text-muted">Results will appear here only after the two-manager submission process has produced an official verified record, or the President has resolved a conflict.</p>
        </section>
      </div>
    </main>
  );
